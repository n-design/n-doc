...
\moduleprocess{prc.vpn.core.connect}{Verbindung zum VPN-Konzentrator aufbauen}
...
%% Für jeden Ablauf gibt es eine solche Überschrift. Der letzte Teil
%% sollte nicht zu lang, aber ausreichend verständlich sein.
\moduleprocess{prc.vpn.core.disconnect}{Verbindung zum VPN-Konzentrator abbbauen}
