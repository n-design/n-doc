...
% Makros für die Auflösung und Darstellung von Subjekten und Objekten. Der
% übergebene Parameter wird anhand der Daten in ubjobj.csv aufgelöst.
...
\newcommand{\sfrlink}[2][]{\hyperlink{\sfrmain{#2}}{\sfr[#1]{#2}}}
