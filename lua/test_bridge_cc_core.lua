...
function testbridge.test_print_subsys_to_sfr_table()
   local expectedresult = [[\begin{enfsfrsubsystable}Enforcing~SFR & \ndocpurpose \\\midrule\relax\sfrlinknoindex{fcs_ckm.2/tls} & Connection establishment, key distribution für TLS\\\sfrlinknoindex{fcs_cop.1/tls.aes} & Provide AES for TLS\\\sfrlinknoindex{fcs_cop.1/tls.auth} & Authentication of TLS peer\\\sfrlinknoindex{fpt_tdc.1/tls.zert} & Certificate validation\\\sfrlinknoindex{ftp_itc.1/tls} & Establish/terminate TLS connections\\\end{enfsfrsubsystable}]]
