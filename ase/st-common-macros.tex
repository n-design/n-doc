...
\newcommand{\assumptionsubsection}[2]{\hypertarget{\directlua{toLower("#1")}}%
  {\minisec{{\normalsize \secitem{#1}} {\small{(#2)}}}%
    \label{\directlua{toLower("#1")}}}}
...
\newcommand{\ospunmodifiedfrompp}[1]{Die in Abschnitt~\objsource{#1} von
  \citepp{} beschriebene organisatorische Sicherheitspolitik \obj{#1} gilt ohne
  Anpassung.}
...
\newcommand{\tracerow}[1]{\textsmaller[2]{\textsf{\nounderscore{#1}}}}
