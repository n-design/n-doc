...
\moduleprocess{prc.tls.core.connect}{Aufbau einer TLS-Verbindung}

\implementedsfr{\sfrlink{ftp_itc.1/tls} & \sfrlink{fcs_cop.1/tls.aes}}

\moduleprocess{prc.tls.core.auth}{Authentisieren des Kommunikationspartners}

\implementedsfr{\sfrlink{fcs_cop.1/tls.auth}}

\moduleprocess{prc.tls.core.disconnect}{Abbau einer TLS-Verbindung}
