...
\sfrdefinition{fcs_cop.1.1/hash}{The TSF shall perform \ppassigned{hash value
    calculation} in accordance with a specified cryptographic algorithm
  \ppassigned{\stdeleted{SHA-1,} SHA-256, \stassigned[list of SHA-2 Algorithms
    with more than 256 bit size]{SHA-512}} and cryptographic key sizes
  \ppassigned{none} that meet the following: \ppassigned{FIPS PUB 180-4
    \autocite{FIPS180-4}}.}
