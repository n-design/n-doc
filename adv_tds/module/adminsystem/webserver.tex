...
\moduleKapitel{mod.adminsystem.webserver}
...
\moduleBeschreibung{mod.adminsystem.webserver.desc}

Über das Modul \tds{mod.adminsystem.webserver} des Subsystems
...
%% Schnittstellen.
\moduleSchnittstellen{int.adminsystem.webserver}
...
\modulSchnittstelleProvided{int.adminsystem.webserver.httpendpoint}

Über diese Schnittstelle wird die logische Schnittstelle \lslanhttpmgmt{}
umgesetzt.

\modulSchnittstelleRequired{int.adminsystem.mgmt.setconfig}

Über die Schnittstelle \tdslink[fq]{int.adminsystem.mgmt.setconfig} speichert
der HTTP-Server die Konfigurationsparameter.

\modulSchnittstelleRequired{int.adminsystem.mgmt.connectdisconnect}

Über die Schnittstelle \tdslink[fq]{int.adminsystem.mgmt.connectdisconnect} ruft
