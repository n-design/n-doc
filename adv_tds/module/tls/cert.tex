...
\moduleBeschreibung{mod.tls.cert.desc}

Über das Modul \tds{mod.tls.cert} des Subsystems
...
%% Schnittstellen.
\moduleSchnittstellen{int.tls.cert}
...
\modulSchnittstelleProvided{int.tls.cert.checkcert}

Über diese Schnittstelle wird das Zertifikat des Kommunikationspartners geprüft.
