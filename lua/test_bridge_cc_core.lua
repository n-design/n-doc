...
function testbridge.test_print_module_to_sfr_table()
   local expectedresult=[[\begin{enfsfrtable}Enforcing~SFR\\\midrule\relax\sfrlinknoindex{fcs_cop.1/tls.aes} & \sfrlinknoindex{fcs_cop.1/tls.auth} & \sfrlinknoindex{ftp_itc.1/tls}\\\end{enfsfrtable}]]
...
function testbridge.test_print_testcase_table()
   expected_result = [[adminsystem1 & \tdslink[fq]{mod.adminsystem.webserver} & \sfr{ftp_trp.1/admin} & \tsfi{ls.lan.httpmgmt}\\__1exadminsystem2 & \tdslink[fq]{mod.adminsystem.webserver} & \sfr{ftp_trp.1/admin} & \tsfi{ls.lan.httpmgmt}\\__1exadminsystem3 & \tdslink[fq]{mod.adminsystem.webserver} & \sfr{ftp_trp.1/admin} & \tsfi{ls.lan.httpmgmt}\\__1excryptsystem1 & \tdslink[fq]{mod.cryptsystem.algorithms} & \sfr{fcs_cop.1/hash} & \tsfi{ls.lan.tls}, \tsfi{ls.wan.ipsec}\\__1excryptsystem2 & \tdslink[fq]{mod.cryptsystem.algorithms} & \sfr{fcs_cop.1/hash} & \tsfi{ls.lan.tls}, \tsfi{ls.wan.ipsec}\\__1excryptsystem3 & \tdslink[fq]{mod.cryptsystem.algorithms} & \sfr{fcs_cop.1/hmac} & \tsfi{ls.lan.tls}, \tsfi{ls.wan.ipsec}\\__1excryptsystem4 & \tdslink[fq]{mod.cryptsystem.keymgmt} & \sfr{fcs_ckm.1} & \tsfi{ls.lan.tls}, \tsfi{ls.wan.ipsec}\\__1excryptsystem5 & \tdslink[fq]{mod.cryptsystem.keymgmt} & \sfr{fcs_ckm.4} & \tsfi{ls.lan.tls}, \tsfi{ls.wan.ipsec}\\__1excryptsystem6 & \tdslink[fq]{mod.cryptsystem.rng} & \sfr{fcs_rng.1/hashdrbg} & \tsfi{ls.lan.tls}, \tsfi{ls.wan.ipsec}\\__1exntp1 & \tdslink[fq]{mod.ntpclient.core} & \sfr{fpt_stm.1} & \tsfi{ls.wan.ntp}\\__1exntp2 & \tdslink[fq]{mod.ntpclient.core} & \sfr{fpt_stm.1} & \tsfi{ls.wan.ntp}\\__1exselfprotect1 & \tdslink[fq]{mod.selfprotect.memory} & \sfr{fdp_rip.1} & \tsfi{no_tsfi}\\__1exselfprotect2 & \tdslink[fq]{mod.selfprotect.selftest} & \sfr{fpt_tst.1} & \tsfi{ls.lan.httpmgmt}\\__1extls1 & \tdslink[fq]{mod.tls.core} & \sfr{ftp_itc.1/tls}, \sfr{fcs_cop.1/tls.aes}, \sfr{fcs_cop.1/tls.auth} & \tsfi{ls.lan.tls}\\__1extls2 & \tdslink[fq]{mod.tls.core} & \sfr{ftp_itc.1/tls}, \sfr{fcs_cop.1/tls.aes}, \sfr{fcs_cop.1/tls.auth} & \tsfi{ls.lan.tls}\\__1extls3 & \tdslink[fq]{mod.tls.cert} & \sfr{fpt_tdc.1/tls.zert} & \tsfi{ls.lan.tls}\\__1extls4 & \tdslink[fq]{mod.tls.cert} & \sfr{fpt_tdc.1/tls.zert} & \tsfi{ls.lan.tls}\\__1extls5 & \tdslink[fq]{mod.tls.cert} & \sfr{fpt_tdc.1/tls.zert} & \tsfi{ls.lan.tls}\\__1exvpn1 & \tdslink[fq]{mod.vpn.core} & \sfr{ftp_itc.1/vpn} & \tsfi{ls.wan.ipsec}\\__1exvpn2 & \tdslink[fq]{mod.vpn.core} & \sfr{ftp_itc.1/vpn} & \tsfi{ls.wan.ipsec}\\__1exvpn3 & \tdslink[fq]{mod.vpn.cert} & \sfr{fpt_tdc.1/zert} & \tsfi{ls.wan.ipsec}\\__1exvpn4 & \tdslink[fq]{mod.vpn.cert} & \sfr{fpt_tdc.1/zert} & \tsfi{ls.wan.ipsec}\\__1exvpn5 & \tdslink[fq]{mod.vpn.cert} & \sfr{fpt_tdc.1/zert} & \tsfi{ls.wan.ipsec}\\__1ex]]
...
function testbridge.test_print_sfr_to_num_testcase_table()
   expected_result = [[\sfr{fcs_ckm.1} & 1 & \sfr{fcs_cop.1/hmac} & 1 & \sfr{fdp_rip.1} & 1 & \sfr{fpt_tst.1} & 1\\\sfr{fcs_ckm.2} & 0 & \sfr{fcs_cop.1/tls.aes} & 2 & \sfr{fpt_tdc.1/tls.zert} & 3 & \sfr{ftp_itc.1/tls} & 2\\\sfr{fcs_ckm.4} & 1 & \sfr{fcs_cop.1/tls.auth} & 2 & \sfr{fpt_tdc.1/zert} & 3 & \sfr{ftp_itc.1/vpn} & 2\\\sfr{fcs_cop.1/hash} & 2 & \sfr{fcs_rng.1/hashdrbg} & 1 & \sfr{fpt_stm.1} & 2 & \sfr{ftp_trp.1/admin} & 3\\]]
