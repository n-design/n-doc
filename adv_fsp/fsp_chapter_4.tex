...
(\sfr{FTP_ITC.1/VPN}, \sfr{FCS_CKM.2}) und handeln Schlüssel für die
...
sie bei IKE eingesetzt werden (\sfrlink{FCS_CKM.1}, \sfrlink{FCS_CKM.2}).
...
gewährleisten. (\sfrlink{fcs_ckm.2})
