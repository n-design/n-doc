...
%% übernommen werden.
\newcommand{\subsystemkapitel}[1]{\clearpage\hrefsection{#1}{\texorpdfstring{Subsystem \secitemfont{\directlua{replacelabel("#1", "no")}}}{Subsystem \directlua{replacelabel("#1", "no")}}}}
...
\newcommand{\modulefuersubsystemkapitel}[2]{\clearpage\section{\texorpdfstring{Module für Subsystem \secitemfont{\directlua{replacelabel("#2", "no")}}}{Module für Subsystem \directlua{replacelabel("#2", "no")}}}\label{#1}}
...
%% zu übergebendes Argument: Das Label (der Hypertextanker) dieses Abschnitts.
%%
\newcommand{\moduleKapitel}[1]{\hrefsubsection{#1}{\texorpdfstring{Modul \secitemfont{\directlua{replacelabel("#1", "fq")}}}{\directlua{replacelabel("#1", "x")}}}}
...
\newcommand{\generatesfrtable}[1]{\noindent{}Das Modul erfüllt die
  Anforderungen, die durch die SFR in \tableref{tab:#1.sfr} an den EVG
  gestellt werden. Das Modul ist \modulStatus{#1} für den TOE.\par{}
