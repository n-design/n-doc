...
function testbridge.test_print_sfr_to_obj_table_body()
   ...
   bridge.print_table_body('mainsfr', 'obj', 'sfrlinknoindex', cc_core.getSfr2Obj, tex.expected(expected_result:gsub("__1ex", "[1ex]")))
end
